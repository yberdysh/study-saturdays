...
*/
var ba=__webpack_require__(2),m=__webpack_require__(10),A=__webpack_require__(4),C=__webpack_require__(3),ea=__webpack_require__(11),fa=__webpack_require__(12),ha=__webpack_require__(13),ja=__webpack_require__(5);
...
var _StudentList = __webpack_require__(53);

var _StudentList2 = _interopRequireDefault(_StudentList);

var _SingleStudent = __webpack_require__(54);
...
var Main = function (_Component) {
    ...
    function Main() {
        ...
        _this.addStudentToDb = _this.addStudentToDb.bind(_this);
    ...
    _createClass(Main, [{
        ...
        key: 'addStudentToDb',
        value: function addStudentToDb(student) {
            var _this3 = this;

            _axios2.default.post('/student', student).then(function (res) {
                return res.data;
            }).then(function (newStud) {
                return _this3.setState({ students: [].concat(_toConsumableArray(_this3.state.students), [newStud]) });
            });
        }
    }, {
        key: 'handleShowForm',
        value: function handleShowForm(evt) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.state.showForm ? _react2.default.createElement(_Form2.default, { studentToAdd: this.addStudentToDb }) : null,
                this.state.selectedStudent.id && _react2.default.createElement(_SingleStudent2.default, { student: this.state.selectedStudent })
            );
        }
    }]);
...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function handleChange(evt) {
      if (evt.target.name === 'firstName' || evt.target.name === 'lastName') {
        ...
        if (evt.target.value.match(/[0-9]/)) {
          console.log("in here");
          return this.setState(_defineProperty({ disabled: true }, evt.target.name, evt.target.value));
        } else {
          return this.setState(_defineProperty({ disabled: false }, evt.target.name, evt.target.value));
        }
      }
    ...
    key: 'disableSubmit',
    value: function disableSubmit(evt) {
        ...
        _react2.default.createElement(
          ...
          this.state.disabled && _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              { style: { color: "red" } },
              'Name must not include numeric characters'
            )
          )
        )
      );
